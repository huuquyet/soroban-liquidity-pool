...
const Swap: FunctionComponent<ISwap> = ({ account, tokenA, tokenB, reserves, onUpdate }) => {
  ...
  const handleChangeTokensOrder = (e: MouseEvent): void => {
    ...
    setFormValues({
      ...formValues,
      sellAmount: formValues.buyAmount,
      buyAmount: formValues.sellAmount,
    })
  }
      ...
      <div className={styles.formContent}>
        <div className={styles.formContentLeft}>
          ...
          <div className={styles.changeOrder}>
            <Button onClick={handleChangeTokensOrder}>
              <SwapIcon />
            </Button>
          </div>
          <InputCurrency
        ...
        <div className={styles.formContentRight}>
          <div className={styles.info}>
            <div className={styles.infoItem}>
              ...
              <div>
                {maxSold} {swapTokens.sell.token.symbol}
              </div>
            </div>
            <div className={styles.infoItem}>
              <div className={styles.infoLabel}>
                ...
                <Tooltip
                  title={
                    'Price based on the last pool query. It may vary until the transaction is confirmed.'
                  }
                  placement="top"
                >
                  <div>
